...
namespace DapperDino.UMT.ObjectSpawning
{
    public class PasswordNetworkManager : MonoBehaviour
    {
        ...
        public void Host()
        {
            ...
            NetworkManager.Singleton.StartHost(new Vector3(0f, 10f, 0f), Quaternion.Euler(0f, 135f, 0f));
        }
        ...
        public void Leave()
        {
            ...
            if (teamPickerUI != null) teamPickerUI.SetActive(false);
        }
        ...
        private void HandleClientConnected(ulong clientId)
        {
            ...
            if (clientId == NetworkManager.Singleton.LocalClientId)
            {
                ...
                if (teamPickerUI != null) teamPickerUI.SetActive(true);
            }
        }
        ...
        private void ApprovalCheck(byte[] connectionData, ulong clientId, MLAPI.NetworkManager.ConnectionApprovedDelegate callback)
        {
            ...
            switch (NetworkManager.Singleton.ConnectedClients.Count)
            {
                ...
                case 1:
                    spawnPos = new Vector3(100f, 100f, 100f);
                    spawnRot = Quaternion.Euler(0f, 180f, 0f);
                    break;
                case 2:
                    spawnPos = new Vector3(50f, 50f, 50f);
